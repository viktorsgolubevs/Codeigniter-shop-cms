    <div id="center_side_block">
        ...
        <div class="pageheader main_block">
            <div class="left"><h2><?=lang('category');?><span><?=lang('category-delete');?> - <?=$category_data['name'];?></span></h2></div>
            <div class="clear"></div>
        </div>
            ...
            <div class="content">
                <div class="content_header">
                    <ul>
                        ...
                        <li class="active"><?=lang('category-delete');?></li>
                    </ul>
                    <div class="clear"></div>
                </div>
                        ...
                        <div class="footer-button-group-container">
                            <div class="button-group-block">
                                <div class="button-position">
                                    <?=form_submit(array('name' => 'delete_category', 'value' => lang('delete'), 'class' => 'btn btn-red'));?>
