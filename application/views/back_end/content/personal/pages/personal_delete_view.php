    <div id="center_side_block">
        ...
        <div class="pageheader main_block">
            <div class="left"><h2><?=lang('personal');?><span>Personal data delete</span></h2></div>
            <div class="clear"></div>
        </div>
        ...
        <div class="block_container content-100">
            ...
            <div class="content">
                <div class="content_header">
                    <ul>
                        <li><a href="<?=site_url('back_end/personal_list');?>">Personal list</a></li>
                        <li class="active">Personal data delete</li>
                    </ul>
                    <div class="clear"></div>
                </div>
                        ...
                        <div class="footer-button-group-container">
                            <div class="button-group-block">
                                <div class="button-position">
                                    <?=form_submit(array('name' => 'delete_user', 'value' => lang('delete'), 'class' => 'btn btn-red'));?>
